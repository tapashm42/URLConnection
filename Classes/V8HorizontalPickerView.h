...
@interface V8HorizontalPickerMiddleLabel : UILabel <V8HorizontalPickerElementState> { }
...
@interface V8HorizontalPickerDetailLabel : UILabel <V8HorizontalPickerElementState> { }
